...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-d7b2d95c.mjs').then((m) => m.default || m)
  }
];
